      ...
      >
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link href="/dashboard/profile">
            <button className="w-12 h-12 rounded-full bg-card shadow-md hover:shadow-lg transition-all flex items-center justify-center group">
              <ArrowLeft className="w-5 h-5 text-muted-foreground group-hover:text-indigo-600 transition-colors" />
            </button>
          </Link>
          <div>
            ...
            <p className="text-muted-foreground mt-1">Canvas EduBot 完整使用教程</p>
          </div>
        </div>
        ...
        >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="prose prose-sm max-w-none">
                  <h3 className="text-lg font-semibold text-foreground">欢迎使用 Canvas EduBot！</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Canvas EduBot 是一个智能学习助手，帮助您更高效地管理 Canvas 课程、作业和学习资料。
                  </p>
                  
                  <h4 className="font-semibold text-foreground mt-4">首次使用步骤：</h4>
          ...
          <motion.div variants={item}>
            <Card>
              ...
              <CardContent className="space-y-6">
                {/* 课程概览 */}
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-3">📚 课程概览</h3>
                ...
                {/* 智能助教总结 */}
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-3">🤖 智能助教总结</h3>
                  <ul className="space-y-2 ml-6 text-muted-foreground">
                    <li className="flex items-start gap-2">
                ...
                {/* 课程资料 AI 分析 */}
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-3">📄 课程资料 AI 分析</h3>
                  <ul className="space-y-2 ml-6 text-muted-foreground">
                    <li className="flex items-start gap-2">
                ...
                {/* 作业管理 */}
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-3">📅 作业管理</h3>
                  <ul className="space-y-2 ml-6 text-muted-foreground">
                    <li className="flex items-start gap-2">
                ...
                {/* 知识库 */}
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-3">📁 知识库</h3>
                  <ul className="space-y-2 ml-6 text-muted-foreground">
                    <li className="flex items-start gap-2">
          ...
          <motion.div variants={item}>
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="prose prose-sm max-w-none">
                  <h3 className="text-lg font-semibold text-foreground">💡 高效使用建议</h3>
                  
                  <h4 className="font-semibold text-foreground mt-4">1. 课程总结功能</h4>
                  ...
                  <h4 className="font-semibold text-foreground mt-4">2. 文件分析功能</h4>
                  <ul className="ml-6 space-y-2 text-muted-foreground">
                  ...
                  <h4 className="font-semibold text-foreground mt-4">3. 作业管理</h4>
                  <ul className="ml-6 space-y-2 text-muted-foreground">
                  ...
                  <h4 className="font-semibold text-foreground mt-4">4. 知识库功能</h4>
                  <ul className="ml-6 space-y-2 text-muted-foreground">
                    <li>上传课外学习资料进行分析</li>
                    <li>支持各种格式的学习笔记</li>
                    <li>文件大小不超过 50 MB</li>
                ...
                <div className="prose prose-sm max-w-none">
                  <div className="space-y-4">
                    <div className="p-4 bg-secondary rounded-xl">
                      <h4 className="font-semibold text-foreground">❓ 为什么看不到课程文件？</h4>
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <h4 className="font-semibold text-foreground">❓ AI 分析需要多长时间？</h4>
                      <p className="text-muted-foreground mt-2">
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <h4 className="font-semibold text-foreground">❓ 支持哪些文件格式？</h4>
                      <p className="text-muted-foreground mt-2">
                        <strong>答：</strong>
                      </p>
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <h4 className="font-semibold text-foreground">❓ 分析失败怎么办？</h4>
                      <p className="text-muted-foreground mt-2">
                        <strong>答：</strong>
                      </p>
                      <ul className="ml-6 mt-2 space-y-1 text-muted-foreground">
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <h4 className="font-semibold text-foreground">❓ 数据安全吗？</h4>
                      <p className="text-muted-foreground mt-2">
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <h4 className="font-semibold text-foreground">❓ 如何退出登录？</h4>
                      <p className="text-muted-foreground mt-2">
            ...
            <Card className="border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-purple-50">
              ...
              <CardContent>
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <div className="mt-4 p-4 bg-card rounded-xl border border-indigo-200">
